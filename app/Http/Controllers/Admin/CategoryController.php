...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Mail::to('adan.clavis@gmail.com')->send(new WelcomeUserMail($data));
