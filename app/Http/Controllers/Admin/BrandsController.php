...
class BrandsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('brand-image')) {
            $image = $request->file('brand-image');
            $name = uniqid() . ".jpg";
    ...
    {
        $status = Brand::where('id', $request->id)->first();
