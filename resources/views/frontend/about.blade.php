                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-lg-5 content">
                        ...
                        <p class="m-0">
                            ...
                            Neque ut
                            neque ut quae voluptas. Maxime corporis aut ut ipsum consequatur. Repudiandae sunt sequi minus
                            qui et.
            ...
            <div class="container">
                ...
                <div class="slides-3 swiper">
                    <div class="swiper-wrapper">
                        @php
                            $images = ['testimonials-1.jpg', 'testimonials-2.jpg', 'testimonials-3.jpg', 'testimonials-4.jpg', 'testimonials-5.jpg'];
                        @endphp
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <div class="profile mt-auto">
                                        <img src="{{ asset('frontend/assets/img/testimonials') }}/{{ $item }}"
