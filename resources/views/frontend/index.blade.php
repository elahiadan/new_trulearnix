...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
            <div class="row">
                <div class="col-lg-8">
                    <h1>Welcome to <span>Chaman Handicrafts</span></h1>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                        <img src="{{ asset('frontend/assets/img/menu/lobster-bisque.jpg') }}" class="menu-img"
                            alt="">
                    ...
                    <div class="col-lg-6 menu-item filter-specialty">
                        <img src="{{ asset('frontend/assets/img/menu/tuscan-grilled.jpg') }}" class="menu-img"
                            alt="">
                        <div class="menu-content">
                    ...
                    <div class="col-lg-6 menu-item filter-starters">
                        <img src="{{ asset('frontend/assets/img/menu/mozzarella.jpg') }}" class="menu-img"
                            alt="">
                        <div class="menu-content">
                    ...
                    <div class="col-lg-6 menu-item filter-salads">
                        <img src="{{ asset('frontend/assets/img/menu/greek-salad.jpg') }}" class="menu-img"
                            alt="">
                        <div class="menu-content">
                    ...
                    <div class="col-lg-6 menu-item filter-salads">
                        <img src="{{ asset('frontend/assets/img/menu/spinach-salad.jpg') }}" class="menu-img"
                            alt="">
                        <div class="menu-content">
                    ...
                    <div class="col-lg-6 menu-item filter-specialty">
                        <img src="{{ asset('frontend/assets/img/menu/lobster-roll.jpg') }}" class="menu-img"
                            alt="">
                        <div class="menu-content">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tab-1">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('frontend/assets/img/specials-1.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('frontend/assets/img/specials-2.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-3">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('frontend/assets/img/specials-3.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('frontend/assets/img/specials-4.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-center order-1 order-lg-2">
                                        <img src="{{ asset('frontend/assets/img/specials-5.png') }}" alt=""
                                            class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="{{ asset('frontend/assets/img/event-birthday.jpg') }}" class="img-fluid"
                                        alt="">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="{{ asset('frontend/assets/img/event-private.jpg') }}" class="img-fluid"
                                        alt="">
                                </div>
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="{{ asset('frontend/assets/img/event-custom.jpg') }}" class="img-fluid"
                                        alt="">
                                </div>
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
