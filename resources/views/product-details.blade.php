    ...
    <div class="popup-mobile-menu">
        <div class="inner-wrapper">
            <div class="inner-top">
                ...
                <p class="description">TruLearnix is a education website template. You can customize all.</p>
                                        ...
                                        <div class="btn-wrapper">
                                            <a class="rbt-btn btn-gradient hover-icon-reverse square btn-xl w-100 text-center mt--30 hover-transform-none" href="#">
                                                <span class="icon-reverse-wrapper">
                                                    <span class="btn-text">Visit TruLearnix Template</span>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="content text-start">
                        ...
                        <h2 class="title">The Complete TruLearnix 2024: From Zero to Expert!</h2>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo1">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo1" aria-expanded="true" aria-controls="collapseTwo1">
                                                    Intro to Course and TruLearnix <span class="rbt-badge-5 ml--10">1hr
                                                        30min</span>
                                                </button>
                                            </h2>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="section-title text-center text-md-start">
                        <h5 class="title mb--0">The Complete TruLearnix 2024: From Zero to Expert!</h5>
                    </div>
                </div>
