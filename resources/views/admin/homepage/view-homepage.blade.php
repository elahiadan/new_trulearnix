                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                    ...
                                    <a href="javascript:void(0);" class="mr-25">
                                        <img src="{{ asset('images/homepage/product') . '/' . $product->image }}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="200" width="300" />
                                    </a>
                                    ...
                                    <form action="{{ route('homepages.upload.image') }}" id="newAvatar"
                                        ...
                                        <div class="media-body mt-75 ml-1">
                                            ...
                                            <input type="file" onchange="changeAvatar()" id="account-upload" name="profile-image" hidden accept="image/*" />
                                        </div>
                                    </form>
                                    <!--/ header media -->
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="heading-elements">
                                                <ul class="list-inline mb-0">
                                                    <li>
                                                        <button onclick="productEdit()" class="btn-icon btn btn-primary btn-round btn-sm" type="button"><i class="mr-50" data-feather="edit"></i></button>
                                                    </li>
                                                    ...
                                                    <div class="card shadow-none bg-transparent border-primary">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="card-body col-lg-6">
                                                                ...
                                                                <p class="card-text">{{ $product->link }}</p>
                                                            </div>
...
<!-- END: Content-->
@include('admin.homepage.edit-homepage')
@endsection
