...
@section('content')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Brand Details</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                        ...
                                        <form action="{{ route('brands.upload.image') }}" id="newAvatar"
    ...
    <!-- END: Content-->
    @include('brands::brand.edit-brand')
@endsection
