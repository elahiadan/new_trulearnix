        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        <input id="vendor-shipping" class="magic-radio" type="radio" name="shipping_type" value="vendor_wise_shipping" @if(get_setting('shipping_type') == 'vendor_wise_shipping') checked @endif>
                        <label for="vendor-shipping">{{translate('Vendor Wise Flat Shipping Cost')}}</label>
                    </div>
                    <div class="radio mar-btm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        3. {{ translate('Vendor Wise Flat Shipping Cost calculation: Fixed rate for each vendor. If customers purchase 2 product from two vendor shipping cost is calculated by addition of each vendor flat shipping cost') }}.
                    </li>
                    <li class="list-group-item">
                        4. {{ translate('Area Wise Flat Shipping Cost calculation: Fixed rate for each area. If customers purchase multiple products from one vendor shipping cost is calculated by the customer shipping area. To configure area wise shipping cost go to ') }} <a href="{{ route('cities.index') }}">{{ translate('Shipping Cities') }}</a>.
                    </li>
                    <li class="list-group-item">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item">
                        {{ translate('1. Shipping cost for admin is applicable if Vendor wise shipping cost is enabled.') }}
                    </li>
                </ul>
            </div>
        </div>
