                    ...
                    <table class="dt-multilingual table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="submit" class="btn btn-info" id="editAll" data-toggle="modal" data-target="#edit_one" onclick="editAll('{{ $page->id }}')">Edit</button>
                                    <a href="{{ route('cms.edit', ['id' => $page->id]) }}" class="btn btn-dark">Edit Content</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
