  <!-- Edit All Data Modal -->
  <div class="modal fade" id="edit_one" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-2">
                            ...
                            <textarea data-length="200" class="form-control char-textarea" id="cms-edit-decription" rows="3"
                    ...
                    <div class="col-12">
                        <div class="form-group mb-2">
                            <select class="form-control js-example-tokenizer" name="keyword[]" id="cms-edit-keyword"
                                multiple="multiple">
                    ...
                    <div class="col-12">
                        <div class="form-group mb-2">
                            <label for="pricing-edit-status">Status</label>
